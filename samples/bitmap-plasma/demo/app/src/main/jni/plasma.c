...
{
    //路径：NDK根目录/platforms/android-XX/arch-arm64/usr/include/android/bitmap.h
    AndroidBitmapInfo  info;//bitmap.h中定义的结构体，用于描述android中的bitmap对象
    void*              pixels;
    int                ret;
    static Stats       stats;
    static int         init;
